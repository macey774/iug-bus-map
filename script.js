...
async function animateBusSmooth(stops, speed, label, company, colorLayer) {
    ...
    // 1?? On calcule UNE SEULE FOIS toute la route complète
...
/* ================================================================
   9?? PANNEAU DE CONTRÔLE STYLE GOOGLE MAPS
================================================================ */
...
let userCoords = null; // coordonnées actuelles
...
document.getElementById('locateBtn').addEventListener('click', () => {
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(pos => {
            ...
            // Marker bleu pour l'utilisateur
